        ...
        <div>
            <div style={{ position: 'relative' }}>
                ...
                <div style={{ position: 'absolute', left: '50%', translate: '-50% 0px', backgroundColor: 'white', padding: '20px 60px', borderRadius: '30px 30px 0 0', bottom: '0px' }}>
                    <p style={{ color: "black", textAlign: 'center', fontFamily: 'serif', fontWeight: '600', fontSize: "40px" }}>Services</p>
                    <p style={{ color: "black", textAlign: 'center', opacity: '0.9' }}>Home / Services</p>
                </div>
            </div>

            <div className='containeR' style={{ width: '1050px', borderInline: '1px solid rgb(0,0,0,0.1)', margin: 'auto' }}>
                <div style={{ display: "flex",flexWrap:'wrap', justifyContent: 'space-around', paddingTop: "130px" }}>
                    <div style={{ padding: '20px', textAlign: 'center', paddingBlock: '60px' }}>
                        ...
                        <p style={{ paddingBlock: "17px", opacity: "0.8", fontSize: '18px' }}>There are many variations of the<br /> passages of lorem Ipsum from<br /> available, majority.</p>
                ...
                <div style={{ display: "flex", gridTemplateColumns: '1fr 1fr 1fr',justifyContent:'space-around',flexWrap:'wrap', gap: '15px', marginTop: "70px" }}>
                    <div style={{ padding: '20px', textAlign: 'center', paddingBlock: '60px' }}>
                ...
                <div style={{ width: "100%", backgroundColor: '#F4F0EC', borderRadius: '45px', marginTop: '200px', paddingInline: "85px" }}>
                    <p style={{ textAlign: 'center', fontSize: '45px', fontFamily: 'serif', fontWeight: '600', paddingTop: '85px' }}>How We Work</p>
                    <p style={{ textAlign: 'center', fontSize: '18px', opacity: '0.7', paddingTop: '15px' }}>It is a long established fact  will be distracted.Lorem Ipsum is simply dummy text of <br />the printing and typesetting industry.</p>

                    <div style={{ display: 'flex', gap: '70px', marginTop: '110px', alignItems: 'center' }}>
                        <img style={{ width: "46%", height: "400px", objectFit: 'cover', borderRadius: '0 80px 0 270px', objectPosition: 'right center' }} src="/servicesWork1.png" />
                        ...
                        <div style={{ width: "50%" }}>
                            ...
                            <p style={{ fontSize: '36px', paddingTop: '45px', fontWeight: '600', fontFamily: 'serif' }}>Concept & Details</p>
                            <p style={{ paddingTop: '5px', opacity: '0.9' }}>It is a long established fact  will be distracted. Lorem Ipsum is simply dummy from text of the and typesetting indufstry. </p>
                        </div>
                    </div>

                    <div style={{ display: 'flex', gap: '70px', marginTop: '90px', alignItems: 'center' }}>
                        <div style={{ width: "50%" }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <p style={{ fontSize: '36px', paddingTop: '45px', fontWeight: '600', fontFamily: 'serif' }}>Idea for Work</p>
                            <p style={{ paddingTop: '5px', opacity: '0.9' }}>It is a long established fact  will be distracted. Lorem Ipsum is simply dummy from text of the and typesetting indufstry. </p>
                        </div>
                        <img style={{ width: "46%", height: "400px", objectFit: 'cover', borderRadius: '0 80px 0 270px', objectPosition: 'right center' }} src="/servicesWork2.png" />
                    </div>

                    <div style={{ display: 'flex', gap: '70px', marginTop: '90px', alignItems: 'center' }}>
                        <img style={{ width: "46%", height: "400px", objectFit: 'cover', borderRadius: '0 80px 0 270px', objectPosition: 'right center' }} src="/servicesWork3.png" />
                        <div style={{ width: "50%" }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <p style={{ fontSize: '36px', paddingTop: '45px', fontWeight: '600', fontFamily: 'serif' }}>Design</p>
                            <p style={{ paddingTop: '5px', opacity: '0.9' }}>It is a long established fact  will be distracted. Lorem Ipsum is simply dummy from text of the and typesetting indufstry. </p>
                        </div>
                    </div>

                    <div style={{ display: 'flex', gap: '70px', marginTop: '90px', paddingBottom: '130px', alignItems: 'center' }}>
                        <div style={{ width: "50%" }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <p style={{ fontSize: '36px', paddingTop: '45px', fontWeight: '600', fontFamily: 'serif' }}>Perfection</p>
                            <p style={{ paddingTop: '5px', opacity: '0.9' }}>It is a long established fact  will be distracted. Lorem Ipsum is simply dummy from text of the and typesetting indufstry. </p>
                        </div>
                        <img style={{ width: "46%", height: "400px", objectFit: 'cover', borderRadius: '0 80px 0 270px', objectPosition: 'right center' }} src="/servicesWork4.png" />
                    </div>
                </div>

                <div style={{ width: '100%', backgroundColor: '#292F36', marginTop: '180px',paddingBottom:'50px', padding: '45px', borderRadius: '45px' }}>
                    <p style={{ textAlign: 'center', color: 'white', fontSize: '42px', paddingTop: '20px', fontFamily: 'serif' }}>Wanna join the interno?</p>
                    <p style={{ textAlign: 'center', padding: '10px', color: 'rgb(258,258,258,0.8)' }}>It is a long established fact  will be distracted.</p>
