        ...
        <div>
            <div style={{ position: 'relative' }}>
                ...
                <div className='pageHeadD' style={{ position: 'absolute', left: '50%', translate: '-50% 0px', backgroundColor: 'white',  borderRadius: '30px 30px 0 0', bottom: '0px' }}>
                    <p className='pageHeadP1' style={{ color: "black", textAlign: 'center', fontFamily: 'serif', fontWeight: '600', }}>Our Professional</p>
                    <p className='pageHeadP2' style={{ color: "black", textAlign: 'center', opacity: '0.9' }}>Home / Team</p>
                </div>
            </div>

            <div className='containeR' style={{ borderInline: '1px solid rgb(0,0,0,0.1)', margin: 'auto' }}>
                <div className='TSC' style={{  gridTemplateColumns: 'repeat(4,1fr)', gap: '50px 5px', paddingTop: '190px' }}>{
                    teamImg.map((e, i) => {
                        return <Link href={{
                            pathname: '/TeamSingle',
           ...
           <Swiper
                ...
                >
                    {
                        teamImg.map(e => {
                            return <SwiperSlide className='SwiperS' >
                                <Link  href={{
                                    pathname: '/TeamSingle',
                                    query: { img: e.img, name: e.name, country: e.country, position: e.position }
                                }}>
                                    <div style={{width:'75%', margin:'auto',display: "grid", placeItems: "center" }}>
                                        <img className='Timg1' src={e.img} style={{ objectFit: 'cover', objectPosition: e.position ? e.position : 'center', borderRadius: '20px', }} />
                                        <p style={{ textAlign: 'center', fontFamily: 'serif', fontWeight: '600', fontSize: '22px', paddingTop: '10px' }}>{e.name}</p>
                                        <p style={{ textAlign: 'center', opacity: '0.8' }}>{e.country}</p>
                                        <div style={{ display: 'flex', gap: '20px', alignItems: 'center', marginTop: '10px', justifyContent: 'center' }}>
                                            <svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
