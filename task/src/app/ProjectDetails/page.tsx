  ...
  return (
    <div>
      ...
      <div className='containeR' style={{ borderInline: '1px solid rgb(0,0,0,0.1)', margin: 'auto' }}>
        <div className='PDgap' style={{ display: 'flex', alignItems: 'center', }}>
          <div className='PDC' style={{ width: "42%", backgroundColor: '#F4F0EC' }}>
            <div className='PDPB' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', }}>
              <p className='PDW' style={{ fontWeight: "600", fontFamily: "serif", opacity: "0.8" }}>Client</p>
              <div style={{ width: '50%' }}>
                <p className='PDWp' style={{ whiteSpace: 'nowrap' }}>Your client name</p>
              </div>
            </div>
            <div className='PDPB' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', }}>
              <p className='PDW' style={{ fontWeight: "600", fontFamily: "serif", opacity: "0.8" }}>Category</p>
              <div style={{ width: '50%' }}>
                <p className='PDWp' style={{ whiteSpace: 'nowrap' }}>Interiors</p>
              </div>
            </div>
            <div className='PDPB' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', }}>
              <p className='PDW' style={{ fontWeight: "600", fontFamily: "serif", opacity: "0.8" }}>Tags </p>
              <div style={{ width: '50%' }}>
                <p className='PDWp' style={{ whiteSpace: 'nowrap' }}>interior, Home</p>
              </div>
            </div>
            <div className='PDPB' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', }}>
              <p className='PDW' style={{ fontWeight: "600", fontFamily: "serif", opacity: "0.8" }}>Date </p>
              <div style={{ width: '50%' }}>
                <p className='PDWp' style={{ whiteSpace: 'nowrap' }}>Date 23,02, 2022</p>
              </div>
            </div>
            <div className='PDPB' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', }}>
              <p className='PDW' style={{ fontWeight: "600", fontFamily: "serif", opacity: "0.8" }}>Link </p>
              <div style={{ width: '50%' }}>
                <p className='PDWp' style={{ whiteSpace: 'nowrap' }}>Link example.com</p>
              </div>
            </div>
          </div>
          <div style={{ width: '58%', }}>
            <p className='PDH1' style={{ fontFamily: 'serif', fontWeight: '600' }}>{projectName ?? 'Living Area'}</p>
            <p className='PDinfo' style={{ opacity: '0.9', paddingTop: '14px', textAlign: 'justify' }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquamsem vitae turpis dignissim maximus. Aliquam sollicitudin tellumassa, vbel maximus purus posuere in. Dojrices gravida dignissim. Praesent at nibh in mi fringilla mattis. Phasellus ut dolor odio. Aenean in the ipsum vel lectus bibendum commodo. </p>
            <p className='PDinfo' style={{ opacity: '0.9', textAlign: 'justify' }}>In nec sem suscipit, convallis leo vitae, lacinia nibh. Cras amet tellus lectus. Vivamus ipsum nunc, mattis quis nibh id, pellentesque arcu. Donec a pellentesque Cras erat enim, gravida non ante vitae,elequis convallis elit, in viverra felis. Donec ultrices tellus vitae iaculisvd porta. Proin tincidunt ligula id purus porttitor.</p>
          </div>
        </div>


        <div style={{ position: 'relative' }}>
          <img className='PDimg2' src={projectImg ?? 'projectD6.png'} style={{ width: '100%',  objectFit: 'cover' }} />
          <svg className='PDimgSvg'  viewBox="0 0 172 172" fill="none" xmlns="http://www.w3.org/2000/svg"
